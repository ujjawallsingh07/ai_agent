...
DB_PASSWORD = "Ujjawal07@golu"     # Replace with your PostgreSQL password
DB_HOST = "localhost"
DB_PORT = "5432"
DB_NAME = "demodb"
...
df_db = ingestion.load_from_database("SELECT * FROM my_table")  # Change 'my_table' to your table name
...
if df_api is not None:
    ...
    df_api = df_api.head(30)  # Adjust as needed

    # 🔹 Reduce long text fields before sending to AI
